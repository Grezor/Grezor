...
- [Grezor/RunAnalysex](https://github.com/Grezor/RunAnalysex) - Analyseur personnel de performances running (2 weeks ago)
...
- [Feature/add composer autoload](https://github.com/Grezor/RunAnalysex/pull/1) on [Grezor/RunAnalysex](https://github.com/Grezor/RunAnalysex) (2 weeks ago)
...
- [roboes/strava-club-scraper](https://github.com/roboes/strava-club-scraper) - Web-scraping tool to extract public activities data from Strava Clubs (without Strava&#39;s API) using Selenium library in Python. (2 days ago)
- [roboes/strava-local-heatmap-tool](https://github.com/roboes/strava-local-heatmap-tool) - Create Strava heatmaps locally using Folium library in Python. (2 days ago)
- [StarTrail-org/PixelRAG](https://github.com/StarTrail-org/PixelRAG) - The end of web parsing. The beginning of scalable pixel-native search. link: https://pixelrag.ai/ (4 days ago)
- [rafaeldrrmachado/strava-activity-downloader](https://github.com/rafaeldrrmachado/strava-activity-downloader) - Download and archive your Strava activities without API access.  Export all your Strava activities directly from the Strava website using Playwright.  No API access required. (5 days ago)
